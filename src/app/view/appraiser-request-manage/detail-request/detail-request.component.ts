...
export class DetailRequestComponent implements OnInit, AfterViewInit {
  ...
  constructor(private common:CommonService,private benifitSer:BenifitService,private illustrationService:IllustrationService,private custService:CustomerService,
    ...
    ngAfterViewInit(): void {
      WebViewer({
        path: '../assets/lib',
        initialDoc: 'https://www.googleapis.com/download/storage/v1/b/tienstorage/o/166_163_Screenshot%20(12).png?generation=1624527887392366&alt=media'
